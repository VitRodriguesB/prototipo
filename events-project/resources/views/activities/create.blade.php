        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-10">
                <h2 class="text-3xl font-black text-white uppercase tracking-tight italic pr-3">
                    ADICIONAR <span class="inline-block pr-2 text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-indigo-600">ATIVIDADE</span>
                </h2>
            ...
            <div class="bg-[#0a0a0a] border border-white/5 rounded-2xl p-8 sm:p-10 shadow-2xl">
                <form method="POST" action="{{ route('activities.store', $event->id) }}" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="3"
                            class="w-full bg-[#121214] border border-white/10 rounded-xl text-white px-4 py-3 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all placeholder-slate-600 shadow-inner"
                            placeholder="Conte um pouco sobre o que será abordado nesta atividade...">{{ old('description') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input id="max_participants" type="number" name="max_participants" value="{{ old('max_participants') }}"
                                class="w-full bg-[#121214] border border-white/10 rounded-xl text-white px-4 py-3 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all placeholder-slate-600 shadow-inner"
