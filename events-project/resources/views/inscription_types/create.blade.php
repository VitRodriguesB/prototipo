        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-10">
                <h2 class="text-3xl font-black text-white uppercase tracking-tight italic pr-3">
                    ADICIONAR <span class="inline-block pr-2 text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-600">TIPO DE INSCRIÇÃO</span>
                </h2>
            ...
            <div class="bg-[#0a0a0a] border border-white/5 rounded-2xl p-8 sm:p-10 shadow-2xl">
                <form method="POST" action="{{ route('inscription_types.store', $event->id) }}" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <input id="type" type="text" name="type" value="{{ old('type') }}" required autofocus
                    ...
                    <div>
                        ...
                        <input id="price" type="number" name="price" value="{{ old('price', 0.00) }}" required step="0.01" min="0"
                    ...
                    <div class="p-6 bg-[#121214] border border-white/5 rounded-xl">
                        <label for="allow_work_submission" class="inline-flex items-center cursor-pointer group">
                            <div class="relative">
                                <input id="allow_work_submission" type="checkbox" class="sr-only peer" name="allow_work_submission" value="1" {{ old('allow_work_submission') ? 'checked' : '' }}>
                    ...
                    <div class="flex justify-end items-center gap-6 mt-8 pt-6 border-t border-white/5">
                        <a href="{{ route('events.edit', $event->id) }}" class="text-[10px] font-black text-slate-500 uppercase tracking-widest hover:text-white transition-colors">
                            {{ __('Cancelar') }}
                        </a>
